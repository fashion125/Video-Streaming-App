...
class EpisodeItemCellModel: ItemTableCellModel {

    private(set) var subtitle: String?
    var itemLabelHeight: CGFloat = 0.0
    ...
    init(item: ItemModel!, height: CGFloat!, cellID: String!, subtitle: String!, actionBlock: @escaping ((_ itemCellModel: ItemTableCellModel) -> Void)) {
    ...
    override func heightValue(width: CGFloat) -> CGFloat {
        ...
        return ht + self.titleLabelHeight + self.itemLabelHeight + self.showMoreButtonHeight + 14
    }
    ...
    private func sizeIsValid(width: CGFloat!) -> Bool {
        ...
        return self.titleLabelHeight + self.itemLabelHeight + self.showMoreButtonHeight + ht + 6 < self.thumbViewHeight
    }
}
