...
public extension UIViewController {
    ...
    */
    public func hideSideMenuView () {
        sideMenuController()?.sideMenu?.hideSideMenu(completion: { 
    ...
    */
    ...
    func fixSideMenuSize() {
        if let navController = self.navigationController as? MenuNavigationController {
...
*/
    ...
    */
    ...
    fileprivate func setupMenuView() {
        ...
        sourceView.bringSubview(toFront: sideMenuContainerView)
    ...
    internal func handlePan(_ recognizer : UIPanGestureRecognizer){
        ...
        default:
            ...
            toggleMenu(!shouldClose, completion: { 
    ...
    */
    open func toggleMenu () {
        ...
        if (isMenuOpen) {
            toggleMenu(false, completion: {
                self.isMenuOpen = false
            })
        }
        else {
            updateSideMenuApperanceIfNeeded()
            toggleMenu(true, completion: {
    ...
    */
    open func hideSideMenu (completion: @escaping (() -> Void)) {
        if (isMenuOpen) {
            toggleMenu(false, completion: completion)
        } else {
            completion()
        }
    }
